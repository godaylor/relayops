# Contributing to RelayOps

Thanks for wanting to contribute to RelayOps. Whether you're fixing bugs, adding features, or improving docs, we appreciate your help.
...
- **Browse the repository's open issues** - look for "good first issue" labels
...
RelayOps uses [i18next](https://www.i18next.com/) with [react-i18next](https://react.i18next.com/) in the web app. We want user-facing copy to stay consistent, translatable, and easy to maintain.
...
- **Issues**: Open a GitHub issue in this repository for bugs or feature requests
...
- **Documentation** - Help others understand how to use RelayOps
- **Performance improvements** - Make things faster
- **Accessibility** - Help make RelayOps usable for everyone

Thanks for contributing to RelayOps! 🚀
