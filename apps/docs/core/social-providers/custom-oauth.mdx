...
|----------|-------------|---------|
| `CUSTOM_OAUTH_CLIENT_ID` | OAuth client ID from your provider | `example` |
| `CUSTOM_OAUTH_CLIENT_SECRET` | OAuth client secret from your provider | `TODO` |
...
```bash
CUSTOM_OAUTH_CLIENT_ID=example
CUSTOM_OAUTH_CLIENT_SECRET=TODO
