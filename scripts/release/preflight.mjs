...
console.log(
  "Manual accessibility review is deferred by explicit owner approval for the demo; the static Pages demo is published, while production release gates remain open.",
);
